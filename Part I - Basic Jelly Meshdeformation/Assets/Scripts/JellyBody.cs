...
public class JellyBody : MonoBehaviour {
	...
	public Mesh JellyMesh {get{ return mesh;} set{ mesh = value;}}
	...
	public float UnitformScale {get {return 1f;}}

	public Vector3[] InitialVerts {get{ return initialVerts;} set{ initialVerts = value;}}
	public Vector3[] DisplacedVerts {get { return displacedVerts;} set{ displacedVerts = value;}}
	public Vector3[] VertVelocities {get { return vertVelocities;} set{ vertVelocities = value;}}
	...
	{
		float sFx = (transform.localScale.x > 1.0f) ? transform.localScale.x - 1.0f : transform.localScale.x;
		float sFy = (transform.localScale.y > 1.0f) ? transform.localScale.y - 1.0f : transform.localScale.y;
		float sFz = (transform.localScale.z > 1.0f) ? transform.localScale.z - 1.0f : transform.localScale.z;
	...
	public void AddPointForce(float _force, Vector3 _pressurePoint)
	{
		...
		JellyManagement.Instance.AddForceToVerts(pressurePoints,_force,this.gameObject,this);
	}
	...
	void OnCollisionStay(Collision other) 
	{
		if(other.contacts.Length > 0)
		{
			...
			JellyManagement.Instance.AddForceToVerts(contactPoints,rigidBody.mass,this.gameObject,this);
		}	
	}
}
